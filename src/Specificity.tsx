    ...
    <main className="container">
      <div className="content post-content">
        <article className="post-text">
          <h1>Specificity</h1>
          <p>1. Progress is the production of more specific ideas.</p>
          <p>
            2. Any real domain is fractal - if something’s there, it keeps
            going.
          </p>
          <p>3. More specific ideas are more valuable (for a smaller group).</p>
