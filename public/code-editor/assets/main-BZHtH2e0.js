import{R as It,r as u,a as xe,j as w,c as an}from"./client-CtlHi3fj.js";const{createElement:we,createContext:sn,forwardRef:Mt,useCallback:V,useContext:Tt,useEffect:ce,useImperativeHandle:Ct,useLayoutEffect:ln,useMemo:cn,useRef:F,useState:Se}=It,lt=It[`useId${Math.random()}`.slice(0,5)],un=ln,Xe=sn(null);Xe.displayName="PanelGroupContext";const ue=un,dn=typeof lt=="function"?lt:()=>null;let fn=0;function nt(e=null){const t=dn(),n=F(e||t||null);return n.current===null&&(n.current=""+fn++),e??n.current}function Et({children:e,className:t="",collapsedSize:n,collapsible:r,defaultSize:o,forwardedRef:a,id:i,maxSize:s,minSize:l,onCollapse:d,onExpand:v,onResize:f,order:c,style:h,tagName:b="div",...k}){const z=Tt(Xe);if(z===null)throw Error("Panel components must be rendered within a PanelGroup container");const{collapsePanel:x,expandPanel:T,getPanelSize:B,getPanelStyle:O,groupId:j,isPanelCollapsed:y,reevaluatePanelConstraints:g,registerPanel:X,resizePanel:N,unregisterPanel:m}=z,C=nt(i),P=F({callbacks:{onCollapse:d,onExpand:v,onResize:f},constraints:{collapsedSize:n,collapsible:r,defaultSize:o,maxSize:s,minSize:l},id:C,idIsFromProps:i!==void 0,order:c});F({didLogMissingDefaultSizeWarning:!1}),ue(()=>{const{callbacks:$,constraints:L}=P.current,D={...L};P.current.id=C,P.current.idIsFromProps=i!==void 0,P.current.order=c,$.onCollapse=d,$.onExpand=v,$.onResize=f,L.collapsedSize=n,L.collapsible=r,L.defaultSize=o,L.maxSize=s,L.minSize=l,(D.collapsedSize!==L.collapsedSize||D.collapsible!==L.collapsible||D.maxSize!==L.maxSize||D.minSize!==L.minSize)&&g(P.current,D)}),ue(()=>{const $=P.current;return X($),()=>{m($)}},[c,C,X,m]),Ct(a,()=>({collapse:()=>{x(P.current)},expand:$=>{T(P.current,$)},getId(){return C},getSize(){return B(P.current)},isCollapsed(){return y(P.current)},isExpanded(){return!y(P.current)},resize:$=>{N(P.current,$)}}),[x,T,B,y,C,N]);const W=O(P.current,o);return we(b,{...k,children:e,className:t,id:i,style:{...W,...h},"data-panel":"","data-panel-collapsible":r||void 0,"data-panel-group-id":j,"data-panel-id":C,"data-panel-size":parseFloat(""+W.flexGrow).toFixed(1)})}const et=Mt((e,t)=>we(Et,{...e,forwardedRef:t}));Et.displayName="Panel";et.displayName="forwardRef(Panel)";let tt=null,le=null;function pn(e,t){if(t){const n=(t&Bt)!==0,r=(t&At)!==0,o=(t&Dt)!==0,a=(t&Nt)!==0;if(n)return o?"se-resize":a?"ne-resize":"e-resize";if(r)return o?"sw-resize":a?"nw-resize":"w-resize";if(o)return"s-resize";if(a)return"n-resize"}switch(e){case"horizontal":return"ew-resize";case"intersection":return"move";case"vertical":return"ns-resize"}}function gn(){le!==null&&(document.head.removeChild(le),tt=null,le=null)}function Fe(e,t){const n=pn(e,t);tt!==n&&(tt=n,le===null&&(le=document.createElement("style"),document.head.appendChild(le)),le.innerHTML=`*{cursor: ${n}!important;}`)}function Pt(e){return e.type==="keydown"}function Rt(e){return e.type.startsWith("pointer")}function jt(e){return e.type.startsWith("mouse")}function Ye(e){if(Rt(e)){if(e.isPrimary)return{x:e.clientX,y:e.clientY}}else if(jt(e))return{x:e.clientX,y:e.clientY};return{x:1/0,y:1/0}}function hn(){if(typeof matchMedia=="function")return matchMedia("(pointer:coarse)").matches?"coarse":"fine"}function mn(e,t,n){return e.x<t.x+t.width&&e.x+e.width>t.x&&e.y<t.y+t.height&&e.y+e.height>t.y}function bn(e,t){if(e===t)throw new Error("Cannot compare node with itself");const n={a:dt(e),b:dt(t)};let r;for(;n.a.at(-1)===n.b.at(-1);)e=n.a.pop(),t=n.b.pop(),r=e;R(r,"Stacking order can only be calculated for elements with a common ancestor");const o={a:ut(ct(n.a)),b:ut(ct(n.b))};if(o.a===o.b){const a=r.childNodes,i={a:n.a.at(-1),b:n.b.at(-1)};let s=a.length;for(;s--;){const l=a[s];if(l===i.a)return 1;if(l===i.b)return-1}}return Math.sign(o.a-o.b)}const yn=/\b(?:position|zIndex|opacity|transform|webkitTransform|mixBlendMode|filter|webkitFilter|isolation)\b/;function vn(e){var t;const n=getComputedStyle((t=Ot(e))!==null&&t!==void 0?t:e).display;return n==="flex"||n==="inline-flex"}function xn(e){const t=getComputedStyle(e);return!!(t.position==="fixed"||t.zIndex!=="auto"&&(t.position!=="static"||vn(e))||+t.opacity<1||"transform"in t&&t.transform!=="none"||"webkitTransform"in t&&t.webkitTransform!=="none"||"mixBlendMode"in t&&t.mixBlendMode!=="normal"||"filter"in t&&t.filter!=="none"||"webkitFilter"in t&&t.webkitFilter!=="none"||"isolation"in t&&t.isolation==="isolate"||yn.test(t.willChange)||t.webkitOverflowScrolling==="touch")}function ct(e){let t=e.length;for(;t--;){const n=e[t];if(R(n,"Missing node"),xn(n))return n}return null}function ut(e){return e&&Number(getComputedStyle(e).zIndex)||0}function dt(e){const t=[];for(;e;)t.push(e),e=Ot(e);return t}function Ot(e){const{parentNode:t}=e;return t&&t instanceof ShadowRoot?t.host:t}const Bt=1,At=2,Dt=4,Nt=8,Sn=hn()==="coarse";let te=[],Ce=!1,oe=new Map,_e=new Map;const Ee=new Set;function wn(e,t,n,r,o){var a;const{ownerDocument:i}=t,s={direction:n,element:t,hitAreaMargins:r,setResizeHandlerState:o},l=(a=oe.get(i))!==null&&a!==void 0?a:0;return oe.set(i,l+1),Ee.add(s),$e(),function(){var v;_e.delete(e),Ee.delete(s);const f=(v=oe.get(i))!==null&&v!==void 0?v:1;if(oe.set(i,f-1),$e(),f===1&&oe.delete(i),te.includes(s)){const c=te.indexOf(s);c>=0&&te.splice(c,1),ot()}}}function ft(e){const{target:t}=e,{x:n,y:r}=Ye(e);Ce=!0,rt({target:t,x:n,y:r}),$e(),te.length>0&&(He("down",e),e.preventDefault(),e.stopPropagation())}function ze(e){const{x:t,y:n}=Ye(e);if(e.buttons===0&&(Ce=!1,He("up",e)),!Ce){const{target:r}=e;rt({target:r,x:t,y:n})}He("move",e),ot(),te.length>0&&e.preventDefault()}function he(e){const{target:t}=e,{x:n,y:r}=Ye(e);_e.clear(),Ce=!1,te.length>0&&e.preventDefault(),He("up",e),rt({target:t,x:n,y:r}),ot(),$e()}function rt({target:e,x:t,y:n}){te.splice(0);let r=null;e instanceof HTMLElement&&(r=e),Ee.forEach(o=>{const{element:a,hitAreaMargins:i}=o,s=a.getBoundingClientRect(),{bottom:l,left:d,right:v,top:f}=s,c=Sn?i.coarse:i.fine;if(t>=d-c&&t<=v+c&&n>=f-c&&n<=l+c){if(r!==null&&a!==r&&!a.contains(r)&&!r.contains(a)&&bn(r,a)>0){let b=r,k=!1;for(;b&&!b.contains(a);){if(mn(b.getBoundingClientRect(),s)){k=!0;break}b=b.parentElement}if(k)return}te.push(o)}})}function Ue(e,t){_e.set(e,t)}function ot(){let e=!1,t=!1;te.forEach(r=>{const{direction:o}=r;o==="horizontal"?e=!0:t=!0});let n=0;_e.forEach(r=>{n|=r}),e&&t?Fe("intersection",n):e?Fe("horizontal",n):t?Fe("vertical",n):gn()}function $e(){oe.forEach((e,t)=>{const{body:n}=t;n.removeEventListener("contextmenu",he),n.removeEventListener("pointerdown",ft),n.removeEventListener("pointerleave",ze),n.removeEventListener("pointermove",ze)}),window.removeEventListener("pointerup",he),window.removeEventListener("pointercancel",he),Ee.size>0&&(Ce?(te.length>0&&oe.forEach((e,t)=>{const{body:n}=t;e>0&&(n.addEventListener("contextmenu",he),n.addEventListener("pointerleave",ze),n.addEventListener("pointermove",ze))}),window.addEventListener("pointerup",he),window.addEventListener("pointercancel",he)):oe.forEach((e,t)=>{const{body:n}=t;e>0&&(n.addEventListener("pointerdown",ft,{capture:!0}),n.addEventListener("pointermove",ze))}))}function He(e,t){Ee.forEach(n=>{const{setResizeHandlerState:r}=n,o=te.includes(n);r(e,o,t)})}function kn(){const[e,t]=Se(0);return V(()=>t(n=>n+1),[])}function R(e,t){if(!e)throw console.error(t),Error(t)}const at=10;function de(e,t,n=at){return e.toFixed(n)===t.toFixed(n)?0:e>t?1:-1}function ne(e,t,n=at){return de(e,t,n)===0}function q(e,t,n){return de(e,t,n)===0}function zn(e,t,n){if(e.length!==t.length)return!1;for(let r=0;r<e.length;r++){const o=e[r],a=t[r];if(!q(o,a,n))return!1}return!0}function ye({panelConstraints:e,panelIndex:t,size:n}){const r=e[t];R(r!=null,`Panel constraints not found for index ${t}`);let{collapsedSize:o=0,collapsible:a,maxSize:i=100,minSize:s=0}=r;if(de(n,s)<0)if(a){const l=(o+s)/2;de(n,l)<0?n=o:n=s}else n=s;return n=Math.min(i,n),n=parseFloat(n.toFixed(at)),n}function Le({delta:e,initialLayout:t,panelConstraints:n,pivotIndices:r,prevLayout:o,trigger:a}){if(q(e,0))return t;const i=[...t],[s,l]=r;R(s!=null,"Invalid first pivot index"),R(l!=null,"Invalid second pivot index");let d=0;if(a==="keyboard"){{const f=e<0?l:s,c=n[f];R(c,`Panel constraints not found for index ${f}`);const{collapsedSize:h=0,collapsible:b,minSize:k=0}=c;if(b){const z=t[f];if(R(z!=null,`Previous layout not found for panel index ${f}`),q(z,h)){const x=k-z;de(x,Math.abs(e))>0&&(e=e<0?0-x:x)}}}{const f=e<0?s:l,c=n[f];R(c,`No panel constraints found for index ${f}`);const{collapsedSize:h=0,collapsible:b,minSize:k=0}=c;if(b){const z=t[f];if(R(z!=null,`Previous layout not found for panel index ${f}`),q(z,k)){const x=z-h;de(x,Math.abs(e))>0&&(e=e<0?0-x:x)}}}}{const f=e<0?1:-1;let c=e<0?l:s,h=0;for(;;){const k=t[c];R(k!=null,`Previous layout not found for panel index ${c}`);const x=ye({panelConstraints:n,panelIndex:c,size:100})-k;if(h+=x,c+=f,c<0||c>=n.length)break}const b=Math.min(Math.abs(e),Math.abs(h));e=e<0?0-b:b}{let c=e<0?s:l;for(;c>=0&&c<n.length;){const h=Math.abs(e)-Math.abs(d),b=t[c];R(b!=null,`Previous layout not found for panel index ${c}`);const k=b-h,z=ye({panelConstraints:n,panelIndex:c,size:k});if(!q(b,z)&&(d+=b-z,i[c]=z,d.toPrecision(3).localeCompare(Math.abs(e).toPrecision(3),void 0,{numeric:!0})>=0))break;e<0?c--:c++}}if(zn(o,i))return o;{const f=e<0?l:s,c=t[f];R(c!=null,`Previous layout not found for panel index ${f}`);const h=c+d,b=ye({panelConstraints:n,panelIndex:f,size:h});if(i[f]=b,!q(b,h)){let k=h-b,x=e<0?l:s;for(;x>=0&&x<n.length;){const T=i[x];R(T!=null,`Previous layout not found for panel index ${x}`);const B=T+k,O=ye({panelConstraints:n,panelIndex:x,size:B});if(q(T,O)||(k-=O-T,i[x]=O),q(k,0))break;e>0?x--:x++}}}const v=i.reduce((f,c)=>c+f,0);return q(v,100)?i:o}function Ln({layout:e,panelsArray:t,pivotIndices:n}){let r=0,o=100,a=0,i=0;const s=n[0];R(s!=null,"No pivot index found"),t.forEach((f,c)=>{const{constraints:h}=f,{maxSize:b=100,minSize:k=0}=h;c===s?(r=k,o=b):(a+=k,i+=b)});const l=Math.min(o,100-a),d=Math.max(r,100-i),v=e[s];return{valueMax:l,valueMin:d,valueNow:v}}function Pe(e,t=document){return Array.from(t.querySelectorAll(`[data-panel-resize-handle-id][data-panel-group-id="${e}"]`))}function $t(e,t,n=document){const o=Pe(e,n).findIndex(a=>a.getAttribute("data-panel-resize-handle-id")===t);return o??null}function Ht(e,t,n){const r=$t(e,t,n);return r!=null?[r,r+1]:[-1,-1]}function Gt(e,t=document){var n;if(t instanceof HTMLElement&&(t==null||(n=t.dataset)===null||n===void 0?void 0:n.panelGroupId)==e)return t;const r=t.querySelector(`[data-panel-group][data-panel-group-id="${e}"]`);return r||null}function We(e,t=document){const n=t.querySelector(`[data-panel-resize-handle-id="${e}"]`);return n||null}function In(e,t,n,r=document){var o,a,i,s;const l=We(t,r),d=Pe(e,r),v=l?d.indexOf(l):-1,f=(o=(a=n[v])===null||a===void 0?void 0:a.id)!==null&&o!==void 0?o:null,c=(i=(s=n[v+1])===null||s===void 0?void 0:s.id)!==null&&i!==void 0?i:null;return[f,c]}function Mn({committedValuesRef:e,eagerValuesRef:t,groupId:n,layout:r,panelDataArray:o,panelGroupElement:a,setLayout:i}){F({didWarnAboutMissingResizeHandle:!1}),ue(()=>{if(!a)return;const s=Pe(n,a);for(let l=0;l<o.length-1;l++){const{valueMax:d,valueMin:v,valueNow:f}=Ln({layout:r,panelsArray:o,pivotIndices:[l,l+1]}),c=s[l];if(c!=null){const h=o[l];R(h,`No panel data found for index "${l}"`),c.setAttribute("aria-controls",h.id),c.setAttribute("aria-valuemax",""+Math.round(d)),c.setAttribute("aria-valuemin",""+Math.round(v)),c.setAttribute("aria-valuenow",f!=null?""+Math.round(f):"")}}return()=>{s.forEach((l,d)=>{l.removeAttribute("aria-controls"),l.removeAttribute("aria-valuemax"),l.removeAttribute("aria-valuemin"),l.removeAttribute("aria-valuenow")})}},[n,r,o,a]),ce(()=>{if(!a)return;const s=t.current;R(s,"Eager values not found");const{panelDataArray:l}=s,d=Gt(n,a);R(d!=null,`No group found for id "${n}"`);const v=Pe(n,a);R(v,`No resize handles found for group id "${n}"`);const f=v.map(c=>{const h=c.getAttribute("data-panel-resize-handle-id");R(h,"Resize handle element has no handle id attribute");const[b,k]=In(n,h,l,a);if(b==null||k==null)return()=>{};const z=x=>{if(!x.defaultPrevented)switch(x.key){case"Enter":{x.preventDefault();const T=l.findIndex(B=>B.id===b);if(T>=0){const B=l[T];R(B,`No panel data found for index ${T}`);const O=r[T],{collapsedSize:j=0,collapsible:y,minSize:g=0}=B.constraints;if(O!=null&&y){const X=Le({delta:q(O,j)?g-j:j-O,initialLayout:r,panelConstraints:l.map(N=>N.constraints),pivotIndices:Ht(n,h,a),prevLayout:r,trigger:"keyboard"});r!==X&&i(X)}}break}}};return c.addEventListener("keydown",z),()=>{c.removeEventListener("keydown",z)}});return()=>{f.forEach(c=>c())}},[a,e,t,n,r,o,i])}function pt(e,t){if(e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0}function Xt(e,t){const n=e==="horizontal",{x:r,y:o}=Ye(t);return n?r:o}function Tn(e,t,n,r,o){const a=n==="horizontal",i=We(t,o);R(i,`No resize handle element found for id "${t}"`);const s=i.getAttribute("data-panel-group-id");R(s,"Resize handle element has no group id attribute");let{initialCursorPosition:l}=r;const d=Xt(n,e),v=Gt(s,o);R(v,`No group element found for id "${s}"`);const f=v.getBoundingClientRect(),c=a?f.width:f.height;return(d-l)/c*100}function Cn(e,t,n,r,o,a){if(Pt(e)){const i=n==="horizontal";let s=0;e.shiftKey?s=100:o!=null?s=o:s=10;let l=0;switch(e.key){case"ArrowDown":l=i?0:s;break;case"ArrowLeft":l=i?-s:0;break;case"ArrowRight":l=i?s:0;break;case"ArrowUp":l=i?0:-s;break;case"End":l=100;break;case"Home":l=-100;break}return l}else return r==null?0:Tn(e,t,n,r,a)}function En({panelDataArray:e}){const t=Array(e.length),n=e.map(a=>a.constraints);let r=0,o=100;for(let a=0;a<e.length;a++){const i=n[a];R(i,`Panel constraints not found for index ${a}`);const{defaultSize:s}=i;s!=null&&(r++,t[a]=s,o-=s)}for(let a=0;a<e.length;a++){const i=n[a];R(i,`Panel constraints not found for index ${a}`);const{defaultSize:s}=i;if(s!=null)continue;const l=e.length-r,d=o/l;r++,t[a]=d,o-=d}return t}function me(e,t,n){t.forEach((r,o)=>{const a=e[o];R(a,`Panel data not found for index ${o}`);const{callbacks:i,constraints:s,id:l}=a,{collapsedSize:d=0,collapsible:v}=s,f=n[l];if(f==null||r!==f){n[l]=r;const{onCollapse:c,onExpand:h,onResize:b}=i;b&&b(r,f),v&&(c||h)&&(h&&(f==null||ne(f,d))&&!ne(r,d)&&h(),c&&(f==null||!ne(f,d))&&ne(r,d)&&c())}})}function Ae(e,t){if(e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!=t[n])return!1;return!0}function Pn({defaultSize:e,dragState:t,layout:n,panelData:r,panelIndex:o,precision:a=3}){const i=n[o];let s;return i==null?s=e!=null?e.toPrecision(a):"1":r.length===1?s="1":s=i.toPrecision(a),{flexBasis:0,flexGrow:s,flexShrink:1,overflow:"hidden",pointerEvents:t!==null?"none":void 0}}function Rn(e,t=10){let n=null;return(...o)=>{n!==null&&clearTimeout(n),n=setTimeout(()=>{e(...o)},t)}}function gt(e){try{if(typeof localStorage<"u")e.getItem=t=>localStorage.getItem(t),e.setItem=(t,n)=>{localStorage.setItem(t,n)};else throw new Error("localStorage not supported in this environment")}catch(t){console.error(t),e.getItem=()=>null,e.setItem=()=>{}}}function Yt(e){return`react-resizable-panels:${e}`}function _t(e){return e.map(t=>{const{constraints:n,id:r,idIsFromProps:o,order:a}=t;return o?r:a?`${a}:${JSON.stringify(n)}`:JSON.stringify(n)}).sort((t,n)=>t.localeCompare(n)).join(",")}function Wt(e,t){try{const n=Yt(e),r=t.getItem(n);if(r){const o=JSON.parse(r);if(typeof o=="object"&&o!=null)return o}}catch{}return null}function jn(e,t,n){var r,o;const a=(r=Wt(e,n))!==null&&r!==void 0?r:{},i=_t(t);return(o=a[i])!==null&&o!==void 0?o:null}function On(e,t,n,r,o){var a;const i=Yt(e),s=_t(t),l=(a=Wt(e,o))!==null&&a!==void 0?a:{};l[s]={expandToSizes:Object.fromEntries(n.entries()),layout:r};try{o.setItem(i,JSON.stringify(l))}catch(d){console.error(d)}}function ht({layout:e,panelConstraints:t}){const n=[...e],r=n.reduce((a,i)=>a+i,0);if(n.length!==t.length)throw Error(`Invalid ${t.length} panel layout: ${n.map(a=>`${a}%`).join(", ")}`);if(!q(r,100))for(let a=0;a<t.length;a++){const i=n[a];R(i!=null,`No layout data found for index ${a}`);const s=100/r*i;n[a]=s}let o=0;for(let a=0;a<t.length;a++){const i=n[a];R(i!=null,`No layout data found for index ${a}`);const s=ye({panelConstraints:t,panelIndex:a,size:i});i!=s&&(o+=i-s,n[a]=s)}if(!q(o,0))for(let a=0;a<t.length;a++){const i=n[a];R(i!=null,`No layout data found for index ${a}`);const s=i+o,l=ye({panelConstraints:t,panelIndex:a,size:s});if(i!==l&&(o-=l-i,n[a]=l,q(o,0)))break}return n}const Bn=100,Ie={getItem:e=>(gt(Ie),Ie.getItem(e)),setItem:(e,t)=>{gt(Ie),Ie.setItem(e,t)}},mt={};function Vt({autoSaveId:e=null,children:t,className:n="",direction:r,forwardedRef:o,id:a=null,onLayout:i=null,keyboardResizeBy:s=null,storage:l=Ie,style:d,tagName:v="div",...f}){const c=nt(a),h=F(null),[b,k]=Se(null),[z,x]=Se([]),T=kn(),B=F({}),O=F(new Map),j=F(0),y=F({autoSaveId:e,direction:r,dragState:b,id:c,keyboardResizeBy:s,onLayout:i,storage:l}),g=F({layout:z,panelDataArray:[],panelDataArrayChanged:!1});F({didLogIdAndOrderWarning:!1,didLogPanelConstraintsWarning:!1,prevPanelIds:[]}),Ct(o,()=>({getId:()=>y.current.id,getLayout:()=>{const{layout:p}=g.current;return p},setLayout:p=>{const{onLayout:S}=y.current,{layout:E,panelDataArray:I}=g.current,M=ht({layout:p,panelConstraints:I.map(A=>A.constraints)});pt(E,M)||(x(M),g.current.layout=M,S&&S(M),me(I,M,B.current))}}),[]),ue(()=>{y.current.autoSaveId=e,y.current.direction=r,y.current.dragState=b,y.current.id=c,y.current.onLayout=i,y.current.storage=l}),Mn({committedValuesRef:y,eagerValuesRef:g,groupId:c,layout:z,panelDataArray:g.current.panelDataArray,setLayout:x,panelGroupElement:h.current}),ce(()=>{const{panelDataArray:p}=g.current;if(e){if(z.length===0||z.length!==p.length)return;let S=mt[e];S==null&&(S=Rn(On,Bn),mt[e]=S);const E=[...p],I=new Map(O.current);S(e,E,I,z,l)}},[e,z,l]),ce(()=>{});const X=V(p=>{const{onLayout:S}=y.current,{layout:E,panelDataArray:I}=g.current;if(p.constraints.collapsible){const M=I.map(Q=>Q.constraints),{collapsedSize:A=0,panelSize:H,pivotIndices:_}=se(I,p,E);if(R(H!=null,`Panel size not found for panel "${p.id}"`),!ne(H,A)){O.current.set(p.id,H);const Z=be(I,p)===I.length-1?H-A:A-H,G=Le({delta:Z,initialLayout:E,panelConstraints:M,pivotIndices:_,prevLayout:E,trigger:"imperative-api"});Ae(E,G)||(x(G),g.current.layout=G,S&&S(G),me(I,G,B.current))}}},[]),N=V((p,S)=>{const{onLayout:E}=y.current,{layout:I,panelDataArray:M}=g.current;if(p.constraints.collapsible){const A=M.map(ee=>ee.constraints),{collapsedSize:H=0,panelSize:_=0,minSize:Q=0,pivotIndices:Z}=se(M,p,I),G=S??Q;if(ne(_,H)){const ee=O.current.get(p.id),Oe=ee!=null&&ee>=G?ee:G,Be=be(M,p)===M.length-1?_-Oe:Oe-_,ie=Le({delta:Be,initialLayout:I,panelConstraints:A,pivotIndices:Z,prevLayout:I,trigger:"imperative-api"});Ae(I,ie)||(x(ie),g.current.layout=ie,E&&E(ie),me(M,ie,B.current))}}},[]),m=V(p=>{const{layout:S,panelDataArray:E}=g.current,{panelSize:I}=se(E,p,S);return R(I!=null,`Panel size not found for panel "${p.id}"`),I},[]),C=V((p,S)=>{const{panelDataArray:E}=g.current,I=be(E,p);return Pn({defaultSize:S,dragState:b,layout:z,panelData:E,panelIndex:I})},[b,z]),P=V(p=>{const{layout:S,panelDataArray:E}=g.current,{collapsedSize:I=0,collapsible:M,panelSize:A}=se(E,p,S);return R(A!=null,`Panel size not found for panel "${p.id}"`),M===!0&&ne(A,I)},[]),W=V(p=>{const{layout:S,panelDataArray:E}=g.current,{collapsedSize:I=0,collapsible:M,panelSize:A}=se(E,p,S);return R(A!=null,`Panel size not found for panel "${p.id}"`),!M||de(A,I)>0},[]),$=V(p=>{const{panelDataArray:S}=g.current;S.push(p),S.sort((E,I)=>{const M=E.order,A=I.order;return M==null&&A==null?0:M==null?-1:A==null?1:M-A}),g.current.panelDataArrayChanged=!0,T()},[T]);ue(()=>{if(g.current.panelDataArrayChanged){g.current.panelDataArrayChanged=!1;const{autoSaveId:p,onLayout:S,storage:E}=y.current,{layout:I,panelDataArray:M}=g.current;let A=null;if(p){const _=jn(p,M,E);_&&(O.current=new Map(Object.entries(_.expandToSizes)),A=_.layout)}A==null&&(A=En({panelDataArray:M}));const H=ht({layout:A,panelConstraints:M.map(_=>_.constraints)});pt(I,H)||(x(H),g.current.layout=H,S&&S(H),me(M,H,B.current))}}),ue(()=>{const p=g.current;return()=>{p.layout=[]}},[]);const L=V(p=>function(E){E.preventDefault();const I=h.current;if(!I)return()=>null;const{direction:M,dragState:A,id:H,keyboardResizeBy:_,onLayout:Q}=y.current,{layout:Z,panelDataArray:G}=g.current,{initialLayout:ee}=A??{},Oe=Ht(H,p,I);let re=Cn(E,p,M,A,_,I);const Be=M==="horizontal";document.dir==="rtl"&&Be&&(re=-re);const ie=G.map(on=>on.constraints),ke=Le({delta:re,initialLayout:ee??Z,panelConstraints:ie,pivotIndices:Oe,prevLayout:Z,trigger:Pt(E)?"keyboard":"mouse-or-touch"}),st=!Ae(Z,ke);(Rt(E)||jt(E))&&j.current!=re&&(j.current=re,st?Ue(p,0):Be?Ue(p,re<0?Bt:At):Ue(p,re<0?Dt:Nt)),st&&(x(ke),g.current.layout=ke,Q&&Q(ke),me(G,ke,B.current))},[]),D=V((p,S)=>{const{onLayout:E}=y.current,{layout:I,panelDataArray:M}=g.current,A=M.map(ee=>ee.constraints),{panelSize:H,pivotIndices:_}=se(M,p,I);R(H!=null,`Panel size not found for panel "${p.id}"`);const Z=be(M,p)===M.length-1?H-S:S-H,G=Le({delta:Z,initialLayout:I,panelConstraints:A,pivotIndices:_,prevLayout:I,trigger:"imperative-api"});Ae(I,G)||(x(G),g.current.layout=G,E&&E(G),me(M,G,B.current))},[]),fe=V((p,S)=>{const{layout:E,panelDataArray:I}=g.current,{collapsedSize:M=0,collapsible:A}=S,{collapsedSize:H=0,collapsible:_,maxSize:Q=100,minSize:Z=0}=p.constraints,{panelSize:G}=se(I,p,E);G!=null&&(A&&_&&ne(G,M)?ne(M,H)||D(p,H):G<Z?D(p,Z):G>Q&&D(p,Q))},[D]),J=V((p,S)=>{const{direction:E}=y.current,{layout:I}=g.current;if(!h.current)return;const M=We(p,h.current);R(M,`Drag handle element not found for id "${p}"`);const A=Xt(E,S);k({dragHandleId:p,dragHandleRect:M.getBoundingClientRect(),initialCursorPosition:A,initialLayout:I})},[]),pe=V(()=>{k(null)},[]),ge=V(p=>{const{panelDataArray:S}=g.current,E=be(S,p);E>=0&&(S.splice(E,1),delete B.current[p.id],g.current.panelDataArrayChanged=!0,T())},[T]),Y=cn(()=>({collapsePanel:X,direction:r,dragState:b,expandPanel:N,getPanelSize:m,getPanelStyle:C,groupId:c,isPanelCollapsed:P,isPanelExpanded:W,reevaluatePanelConstraints:fe,registerPanel:$,registerResizeHandle:L,resizePanel:D,startDragging:J,stopDragging:pe,unregisterPanel:ge,panelGroupElement:h.current}),[X,b,r,N,m,C,c,P,W,fe,$,L,D,J,pe,ge]),U={display:"flex",flexDirection:r==="horizontal"?"row":"column",height:"100%",overflow:"hidden",width:"100%"};return we(Xe.Provider,{value:Y},we(v,{...f,children:t,className:n,id:a,ref:h,style:{...U,...d},"data-panel-group":"","data-panel-group-direction":r,"data-panel-group-id":c}))}const Ft=Mt((e,t)=>we(Vt,{...e,forwardedRef:t}));Vt.displayName="PanelGroup";Ft.displayName="forwardRef(PanelGroup)";function be(e,t){return e.findIndex(n=>n===t||n.id===t.id)}function se(e,t,n){const r=be(e,t),a=r===e.length-1?[r-1,r]:[r,r+1],i=n[r];return{...t.constraints,panelSize:i,pivotIndices:a}}function An({disabled:e,handleId:t,resizeHandler:n,panelGroupElement:r}){ce(()=>{if(e||n==null||r==null)return;const o=We(t,r);if(o==null)return;const a=i=>{if(!i.defaultPrevented)switch(i.key){case"ArrowDown":case"ArrowLeft":case"ArrowRight":case"ArrowUp":case"End":case"Home":{i.preventDefault(),n(i);break}case"F6":{i.preventDefault();const s=o.getAttribute("data-panel-group-id");R(s,`No group element found for id "${s}"`);const l=Pe(s,r),d=$t(s,t,r);R(d!==null,`No resize element found for id "${t}"`);const v=i.shiftKey?d>0?d-1:l.length-1:d+1<l.length?d+1:0;l[v].focus();break}}};return o.addEventListener("keydown",a),()=>{o.removeEventListener("keydown",a)}},[r,e,t,n])}function Ut({children:e=null,className:t="",disabled:n=!1,hitAreaMargins:r,id:o,onBlur:a,onDragging:i,onFocus:s,style:l={},tabIndex:d=0,tagName:v="div",...f}){var c,h;const b=F(null),k=F({onDragging:i});ce(()=>{k.current.onDragging=i});const z=Tt(Xe);if(z===null)throw Error("PanelResizeHandle components must be rendered within a PanelGroup container");const{direction:x,groupId:T,registerResizeHandle:B,startDragging:O,stopDragging:j,panelGroupElement:y}=z,g=nt(o),[X,N]=Se("inactive"),[m,C]=Se(!1),[P,W]=Se(null),$=F({state:X});ue(()=>{$.current.state=X}),ce(()=>{if(n)W(null);else{const J=B(g);W(()=>J)}},[n,g,B]);const L=(c=r?.coarse)!==null&&c!==void 0?c:15,D=(h=r?.fine)!==null&&h!==void 0?h:5;return ce(()=>{if(n||P==null)return;const J=b.current;return R(J,"Element ref not attached"),wn(g,J,x,{coarse:L,fine:D},(ge,Y,U)=>{if(Y)switch(ge){case"down":{N("drag"),O(g,U);const{onDragging:p}=k.current;p&&p(!0);break}case"move":{const{state:p}=$.current;p!=="drag"&&N("hover"),P(U);break}case"up":{N("hover"),j();const{onDragging:p}=k.current;p&&p(!1);break}}else N("inactive")})},[L,x,n,D,B,g,P,O,j]),An({disabled:n,handleId:g,resizeHandler:P,panelGroupElement:y}),we(v,{...f,children:e,className:t,id:o,onBlur:()=>{C(!1),a?.()},onFocus:()=>{C(!0),s?.()},ref:b,role:"separator",style:{...{touchAction:"none",userSelect:"none"},...l},tabIndex:d,"data-panel-group-direction":x,"data-panel-group-id":T,"data-resize-handle":"","data-resize-handle-active":X==="drag"?"pointer":m?"keyboard":void 0,"data-resize-handle-state":X,"data-panel-resize-handle-enabled":!n,"data-panel-resize-handle-id":g})}Ut.displayName="PanelResizeHandle";function bt(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}function Dn(e){if(Array.isArray(e))return e}function Nn(e,t,n){return(t=Wn(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function $n(e,t){var n=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(n!=null){var r,o,a,i,s=[],l=!0,d=!1;try{if(a=(n=n.call(e)).next,t!==0)for(;!(l=(r=a.call(n)).done)&&(s.push(r.value),s.length!==t);l=!0);}catch(v){d=!0,o=v}finally{try{if(!l&&n.return!=null&&(i=n.return(),Object(i)!==i))return}finally{if(d)throw o}}return s}}function Hn(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function yt(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(o){return Object.getOwnPropertyDescriptor(e,o).enumerable})),n.push.apply(n,r)}return n}function vt(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?yt(Object(n),!0).forEach(function(r){Nn(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):yt(Object(n)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function Gn(e,t){if(e==null)return{};var n,r,o=Xn(e,t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);for(r=0;r<a.length;r++)n=a[r],t.indexOf(n)===-1&&{}.propertyIsEnumerable.call(e,n)&&(o[n]=e[n])}return o}function Xn(e,t){if(e==null)return{};var n={};for(var r in e)if({}.hasOwnProperty.call(e,r)){if(t.indexOf(r)!==-1)continue;n[r]=e[r]}return n}function Yn(e,t){return Dn(e)||$n(e,t)||Vn(e,t)||Hn()}function _n(e,t){if(typeof e!="object"||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t);if(typeof r!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}function Wn(e){var t=_n(e,"string");return typeof t=="symbol"?t:t+""}function Vn(e,t){if(e){if(typeof e=="string")return bt(e,t);var n={}.toString.call(e).slice(8,-1);return n==="Object"&&e.constructor&&(n=e.constructor.name),n==="Map"||n==="Set"?Array.from(e):n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?bt(e,t):void 0}}function Fn(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function xt(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(o){return Object.getOwnPropertyDescriptor(e,o).enumerable})),n.push.apply(n,r)}return n}function St(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?xt(Object(n),!0).forEach(function(r){Fn(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):xt(Object(n)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function Un(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(r){return t.reduceRight(function(o,a){return a(o)},r)}}function Me(e){return function t(){for(var n=this,r=arguments.length,o=new Array(r),a=0;a<r;a++)o[a]=arguments[a];return o.length>=e.length?e.apply(this,o):function(){for(var i=arguments.length,s=new Array(i),l=0;l<i;l++)s[l]=arguments[l];return t.apply(n,[].concat(o,s))}}}function Ge(e){return{}.toString.call(e).includes("Object")}function qn(e){return!Object.keys(e).length}function Re(e){return typeof e=="function"}function Kn(e,t){return Object.prototype.hasOwnProperty.call(e,t)}function Zn(e,t){return Ge(t)||ae("changeType"),Object.keys(t).some(function(n){return!Kn(e,n)})&&ae("changeField"),t}function Jn(e){Re(e)||ae("selectorType")}function Qn(e){Re(e)||Ge(e)||ae("handlerType"),Ge(e)&&Object.values(e).some(function(t){return!Re(t)})&&ae("handlersType")}function er(e){e||ae("initialIsRequired"),Ge(e)||ae("initialType"),qn(e)&&ae("initialContent")}function tr(e,t){throw new Error(e[t]||e.default)}var nr={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},ae=Me(tr)(nr),De={changes:Zn,selector:Jn,handler:Qn,initial:er};function rr(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};De.initial(e),De.handler(t);var n={current:e},r=Me(ir)(n,t),o=Me(ar)(n),a=Me(De.changes)(e),i=Me(or)(n);function s(){var d=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(v){return v};return De.selector(d),d(n.current)}function l(d){Un(r,o,a,i)(d)}return[s,l]}function or(e,t){return Re(t)?t(e.current):t}function ar(e,t){return e.current=St(St({},e.current),t),t}function ir(e,t,n){return Re(t)?t(e.current):Object.keys(n).forEach(function(r){var o;return(o=t[r])===null||o===void 0?void 0:o.call(t,e.current[r])}),n}var sr={create:rr},lr={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.55.1/min/vs"}};function cr(e){return function t(){for(var n=this,r=arguments.length,o=new Array(r),a=0;a<r;a++)o[a]=arguments[a];return o.length>=e.length?e.apply(this,o):function(){for(var i=arguments.length,s=new Array(i),l=0;l<i;l++)s[l]=arguments[l];return t.apply(n,[].concat(o,s))}}}function ur(e){return{}.toString.call(e).includes("Object")}function dr(e){return e||wt("configIsRequired"),ur(e)||wt("configType"),e.urls?(fr(),{paths:{vs:e.urls.monacoBase}}):e}function fr(){console.warn(qt.deprecation)}function pr(e,t){throw new Error(e[t]||e.default)}var qt={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},wt=cr(pr)(qt),gr={config:dr},hr=function(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(o){return n.reduceRight(function(a,i){return i(a)},o)}};function Kt(e,t){return Object.keys(t).forEach(function(n){t[n]instanceof Object&&e[n]&&Object.assign(t[n],Kt(e[n],t[n]))}),vt(vt({},e),t)}var mr={type:"cancelation",msg:"operation is manually canceled"};function qe(e){var t=!1,n=new Promise(function(r,o){e.then(function(a){return t?o(mr):r(a)}),e.catch(o)});return n.cancel=function(){return t=!0},n}var br=["monaco"],yr=sr.create({config:lr,isInitialized:!1,resolve:null,reject:null,monaco:null}),Zt=Yn(yr,2),je=Zt[0],Ve=Zt[1];function vr(e){var t=gr.config(e),n=t.monaco,r=Gn(t,br);Ve(function(o){return{config:Kt(o.config,r),monaco:n}})}function xr(){var e=je(function(t){var n=t.monaco,r=t.isInitialized,o=t.resolve;return{monaco:n,isInitialized:r,resolve:o}});if(!e.isInitialized){if(Ve({isInitialized:!0}),e.monaco)return e.resolve(e.monaco),qe(Ke);if(window.monaco&&window.monaco.editor)return Jt(window.monaco),e.resolve(window.monaco),qe(Ke);hr(Sr,kr)(zr)}return qe(Ke)}function Sr(e){return document.body.appendChild(e)}function wr(e){var t=document.createElement("script");return e&&(t.src=e),t}function kr(e){var t=je(function(r){var o=r.config,a=r.reject;return{config:o,reject:a}}),n=wr("".concat(t.config.paths.vs,"/loader.js"));return n.onload=function(){return e()},n.onerror=t.reject,n}function zr(){var e=je(function(n){var r=n.config,o=n.resolve,a=n.reject;return{config:r,resolve:o,reject:a}}),t=window.require;t.config(e.config),t(["vs/editor/editor.main"],function(n){var r=n.m||n;Jt(r),e.resolve(r)},function(n){e.reject(n)})}function Jt(e){je().monaco||Ve({monaco:e})}function Lr(){return je(function(e){var t=e.monaco;return t})}var Ke=new Promise(function(e,t){return Ve({resolve:e,reject:t})}),Qt={config:vr,init:xr,__getMonacoInstance:Lr},Ir={wrapper:{display:"flex",position:"relative",textAlign:"initial"},fullWidth:{width:"100%"},hide:{display:"none"}},Ze=Ir,Mr={container:{display:"flex",height:"100%",width:"100%",justifyContent:"center",alignItems:"center"}},Tr=Mr;function Cr({children:e}){return xe.createElement("div",{style:Tr.container},e)}var Er=Cr,Pr=Er;function Rr({width:e,height:t,isEditorReady:n,loading:r,_ref:o,className:a,wrapperProps:i}){return xe.createElement("section",{style:{...Ze.wrapper,width:e,height:t},...i},!n&&xe.createElement(Pr,null,r),xe.createElement("div",{ref:o,style:{...Ze.fullWidth,...!n&&Ze.hide},className:a}))}var jr=Rr,en=u.memo(jr);function Or(e){u.useEffect(e,[])}var tn=Or;function Br(e,t,n=!0){let r=u.useRef(!0);u.useEffect(r.current||!n?()=>{r.current=!1}:e,t)}var K=Br;function Te(){}function ve(e,t,n,r){return Ar(e,r)||Dr(e,t,n,r)}function Ar(e,t){return e.editor.getModel(nn(e,t))}function Dr(e,t,n,r){return e.editor.createModel(t,n,r?nn(e,r):void 0)}function nn(e,t){return e.Uri.parse(t)}function Nr({original:e,modified:t,language:n,originalLanguage:r,modifiedLanguage:o,originalModelPath:a,modifiedModelPath:i,keepCurrentOriginalModel:s=!1,keepCurrentModifiedModel:l=!1,theme:d="light",loading:v="Loading...",options:f={},height:c="100%",width:h="100%",className:b,wrapperProps:k={},beforeMount:z=Te,onMount:x=Te}){let[T,B]=u.useState(!1),[O,j]=u.useState(!0),y=u.useRef(null),g=u.useRef(null),X=u.useRef(null),N=u.useRef(x),m=u.useRef(z),C=u.useRef(!1);tn(()=>{let L=Qt.init();return L.then(D=>(g.current=D)&&j(!1)).catch(D=>D?.type!=="cancelation"&&console.error("Monaco initialization: error:",D)),()=>y.current?$():L.cancel()}),K(()=>{if(y.current&&g.current){let L=y.current.getOriginalEditor(),D=ve(g.current,e||"",r||n||"text",a||"");D!==L.getModel()&&L.setModel(D)}},[a],T),K(()=>{if(y.current&&g.current){let L=y.current.getModifiedEditor(),D=ve(g.current,t||"",o||n||"text",i||"");D!==L.getModel()&&L.setModel(D)}},[i],T),K(()=>{let L=y.current.getModifiedEditor();L.getOption(g.current.editor.EditorOption.readOnly)?L.setValue(t||""):t!==L.getValue()&&(L.executeEdits("",[{range:L.getModel().getFullModelRange(),text:t||"",forceMoveMarkers:!0}]),L.pushUndoStop())},[t],T),K(()=>{y.current?.getModel()?.original.setValue(e||"")},[e],T),K(()=>{let{original:L,modified:D}=y.current.getModel();g.current.editor.setModelLanguage(L,r||n||"text"),g.current.editor.setModelLanguage(D,o||n||"text")},[n,r,o],T),K(()=>{g.current?.editor.setTheme(d)},[d],T),K(()=>{y.current?.updateOptions(f)},[f],T);let P=u.useCallback(()=>{if(!g.current)return;m.current(g.current);let L=ve(g.current,e||"",r||n||"text",a||""),D=ve(g.current,t||"",o||n||"text",i||"");y.current?.setModel({original:L,modified:D})},[n,t,o,e,r,a,i]),W=u.useCallback(()=>{!C.current&&X.current&&(y.current=g.current.editor.createDiffEditor(X.current,{automaticLayout:!0,...f}),P(),g.current?.editor.setTheme(d),B(!0),C.current=!0)},[f,d,P]);u.useEffect(()=>{T&&N.current(y.current,g.current)},[T]),u.useEffect(()=>{!O&&!T&&W()},[O,T,W]);function $(){let L=y.current?.getModel();s||L?.original?.dispose(),l||L?.modified?.dispose(),y.current?.dispose()}return xe.createElement(en,{width:h,height:c,isEditorReady:T,loading:v,_ref:X,className:b,wrapperProps:k})}var $r=Nr;u.memo($r);function Hr(e){let t=u.useRef();return u.useEffect(()=>{t.current=e},[e]),t.current}var Gr=Hr,Ne=new Map;function Xr({defaultValue:e,defaultLanguage:t,defaultPath:n,value:r,language:o,path:a,theme:i="light",line:s,loading:l="Loading...",options:d={},overrideServices:v={},saveViewState:f=!0,keepCurrentModel:c=!1,width:h="100%",height:b="100%",className:k,wrapperProps:z={},beforeMount:x=Te,onMount:T=Te,onChange:B,onValidate:O=Te}){let[j,y]=u.useState(!1),[g,X]=u.useState(!0),N=u.useRef(null),m=u.useRef(null),C=u.useRef(null),P=u.useRef(T),W=u.useRef(x),$=u.useRef(),L=u.useRef(r),D=Gr(a),fe=u.useRef(!1),J=u.useRef(!1);tn(()=>{let Y=Qt.init();return Y.then(U=>(N.current=U)&&X(!1)).catch(U=>U?.type!=="cancelation"&&console.error("Monaco initialization: error:",U)),()=>m.current?ge():Y.cancel()}),K(()=>{let Y=ve(N.current,e||r||"",t||o||"",a||n||"");Y!==m.current?.getModel()&&(f&&Ne.set(D,m.current?.saveViewState()),m.current?.setModel(Y),f&&m.current?.restoreViewState(Ne.get(a)))},[a],j),K(()=>{m.current?.updateOptions(d)},[d],j),K(()=>{!m.current||r===void 0||(m.current.getOption(N.current.editor.EditorOption.readOnly)?m.current.setValue(r):r!==m.current.getValue()&&(J.current=!0,m.current.executeEdits("",[{range:m.current.getModel().getFullModelRange(),text:r,forceMoveMarkers:!0}]),m.current.pushUndoStop(),J.current=!1))},[r],j),K(()=>{let Y=m.current?.getModel();Y&&o&&N.current?.editor.setModelLanguage(Y,o)},[o],j),K(()=>{s!==void 0&&m.current?.revealLine(s)},[s],j),K(()=>{N.current?.editor.setTheme(i)},[i],j);let pe=u.useCallback(()=>{if(!(!C.current||!N.current)&&!fe.current){W.current(N.current);let Y=a||n,U=ve(N.current,r||e||"",t||o||"",Y||"");m.current=N.current?.editor.create(C.current,{model:U,automaticLayout:!0,...d},v),f&&m.current.restoreViewState(Ne.get(Y)),N.current.editor.setTheme(i),s!==void 0&&m.current.revealLine(s),y(!0),fe.current=!0}},[e,t,n,r,o,a,d,v,f,i,s]);u.useEffect(()=>{j&&P.current(m.current,N.current)},[j]),u.useEffect(()=>{!g&&!j&&pe()},[g,j,pe]),L.current=r,u.useEffect(()=>{j&&B&&($.current?.dispose(),$.current=m.current?.onDidChangeModelContent(Y=>{J.current||B(m.current.getValue(),Y)}))},[j,B]),u.useEffect(()=>{if(j){let Y=N.current.editor.onDidChangeMarkers(U=>{let p=m.current.getModel()?.uri;if(p&&U.find(S=>S.path===p.path)){let S=N.current.editor.getModelMarkers({resource:p});O?.(S)}});return()=>{Y?.dispose()}}return()=>{}},[j,O]);function ge(){$.current?.dispose(),c?f&&Ne.set(a,m.current.saveViewState()):m.current.getModel()?.dispose(),m.current.dispose()}return xe.createElement(en,{width:h,height:b,isEditorReady:j,loading:l,_ref:C,className:k,wrapperProps:z})}var Yr=Xr,_r=u.memo(Yr),Wr=_r;const Vr=`
interface VecLike {
  x: number
  y: number
  z?: number
...
canvas.zoomToFit({ animation: { duration: 400 } })`,it=[{name:to,code:no},{name:qr,code:Kr},{name:Zr,code:Jr},{name:Qr,code:eo},{name:Fr,code:Ur}],ro=Object.fromEntries(it.map(e=>[e.name,e.code])),oo=it[0]?.code??"",ao=["Flower","Clock","Pool","Life","Sphere"];function io({onLoadExample:e,selectedExample:t}){const n=ao.map(r=>it.find(o=>o.name===r)).filter(Boolean);return w.jsx("div",{className:"examples-sidebar",children:w.jsx("div",{className:"examples-sidebar-content",children:n.map(r=>w.jsx("button",{className:`examples-item ${r.name===t?"selected":""}`,onClick:()=>e(r.name,r.code),children:r.name},r.name))})})}const so={base:"vs",inherit:!1,rules:[{token:"",foreground:"5c6166",background:"fafafa"},{token:"comment",foreground:"787b80",fontStyle:"italic"},{token:"comment.js",foreground:"787b80",fontStyle:"italic"},{token:"comment.line",foreground:"787b80",fontStyle:"italic"},{token:"comment.block",foreground:"787b80",fontStyle:"italic"},{token:"string",foreground:"86b300"},{token:"string.js",foreground:"86b300"},{token:"string.quoted",foreground:"86b300"},{token:"string.template",foreground:"86b300"},{token:"number",foreground:"a37acc"},{token:"number.js",foreground:"a37acc"},{token:"constant.numeric",foreground:"a37acc"},{token:"keyword",foreground:"fa8d3e"},{token:"keyword.js",foreground:"fa8d3e"},{token:"keyword.control",foreground:"fa8d3e"},{token:"keyword.operator",foreground:"ed9366"},{token:"keyword.other",foreground:"fa8d3e"},{token:"storage",foreground:"fa8d3e"},{token:"storage.type",foreground:"fa8d3e"},{token:"operator",foreground:"ed9366"},{token:"delimiter",foreground:"5c616680"},{token:"delimiter.bracket",foreground:"5c616680"},{token:"delimiter.parenthesis",foreground:"5c616680"},{token:"entity.name.function",foreground:"f2ae49"},{token:"support.function",foreground:"f2ae49"},{token:"function",foreground:"f2ae49"},{token:"identifier.js",foreground:"5c6166"},{token:"variable",foreground:"5c6166"},{token:"variable.parameter",foreground:"a37acc"},{token:"variable.other",foreground:"5c6166"},{token:"identifier",foreground:"5c6166"},{token:"constant",foreground:"a37acc"},{token:"constant.language",foreground:"a37acc"},{token:"constant.language.boolean",foreground:"a37acc"},{token:"constant.language.null",foreground:"a37acc"},{token:"constant.language.undefined",foreground:"a37acc"},{token:"type",foreground:"399ee6"},{token:"type.identifier",foreground:"399ee6"},{token:"entity.name.type",foreground:"399ee6"},{token:"entity.name.class",foreground:"399ee6"},{token:"class",foreground:"399ee6"},{token:"interface",foreground:"399ee6"},{token:"support.class",foreground:"399ee6"},{token:"support.type",foreground:"399ee6"},{token:"tag",foreground:"55b4d4"},{token:"tag.js",foreground:"55b4d4"},{token:"metatag",foreground:"55b4d4"},{token:"attribute.name",foreground:"f2ae49"},{token:"attribute.value",foreground:"86b300"},{token:"regexp",foreground:"4cbf99"},{token:"string.regexp",foreground:"4cbf99"},{token:"meta.brace",foreground:"5c616680"},{token:"punctuation",foreground:"5c616680"}],colors:{"editor.background":"#fafafa","editor.foreground":"#5c6166","editor.lineHighlightBackground":"#f0f0f0","editor.lineHighlightBorder":"#f0f0f0","editor.selectionBackground":"#d1e4f4","editor.inactiveSelectionBackground":"#e8e8e8","editorLineNumber.foreground":"#9199a1","editorLineNumber.activeForeground":"#5c6166","editorCursor.foreground":"#ff9940","editorWhitespace.foreground":"#d9d9d9","editorIndentGuide.background":"#e8e8e8","editorIndentGuide.activeBackground":"#d0d0d0","editorGutter.background":"#f3f3f3","editorWidget.background":"#fafafa","editorWidget.border":"#e0e0e0","editorSuggestWidget.background":"#fafafa","editorSuggestWidget.border":"#e0e0e0","editorSuggestWidget.selectedBackground":"#d1e4f4","editorHoverWidget.background":"#fafafa","editorHoverWidget.border":"#e0e0e0","input.background":"#ffffff","input.border":"#e0e0e0",focusBorder:"#ff994033","list.activeSelectionBackground":"#d1e4f4","list.hoverBackground":"#e8e8e8","scrollbarSlider.background":"#9199a133","scrollbarSlider.hoverBackground":"#9199a155","scrollbarSlider.activeBackground":"#9199a177"}},lo={base:"vs-dark",inherit:!1,rules:[{token:"",foreground:"cbccc6",background:"1f2430"},{token:"comment",foreground:"5c6773",fontStyle:"italic"},{token:"comment.js",foreground:"5c6773",fontStyle:"italic"},{token:"comment.line",foreground:"5c6773",fontStyle:"italic"},{token:"comment.block",foreground:"5c6773",fontStyle:"italic"},{token:"string",foreground:"bae67e"},{token:"string.js",foreground:"bae67e"},{token:"string.quoted",foreground:"bae67e"},{token:"string.template",foreground:"bae67e"},{token:"number",foreground:"ffcc66"},{token:"number.js",foreground:"ffcc66"},{token:"constant.numeric",foreground:"ffcc66"},{token:"keyword",foreground:"ffa759"},{token:"keyword.js",foreground:"ffa759"},{token:"keyword.control",foreground:"ffa759"},{token:"keyword.operator",foreground:"f29e74"},{token:"keyword.other",foreground:"ffa759"},{token:"storage",foreground:"ffa759"},{token:"storage.type",foreground:"ffa759"},{token:"operator",foreground:"f29e74"},{token:"delimiter",foreground:"cbccc6b3"},{token:"delimiter.bracket",foreground:"cbccc6b3"},{token:"delimiter.parenthesis",foreground:"cbccc6b3"},{token:"entity.name.function",foreground:"ffd580"},{token:"support.function",foreground:"ffd580"},{token:"function",foreground:"ffd580"},{token:"identifier.js",foreground:"cbccc6"},{token:"variable",foreground:"cbccc6"},{token:"variable.parameter",foreground:"d4bfff"},{token:"variable.other",foreground:"cbccc6"},{token:"identifier",foreground:"cbccc6"},{token:"constant",foreground:"ffcc66"},{token:"constant.language",foreground:"ffcc66"},{token:"constant.language.boolean",foreground:"ffcc66"},{token:"constant.language.null",foreground:"ffcc66"},{token:"constant.language.undefined",foreground:"ffcc66"},{token:"type",foreground:"73d0ff"},{token:"type.identifier",foreground:"73d0ff"},{token:"entity.name.type",foreground:"73d0ff"},{token:"entity.name.class",foreground:"73d0ff"},{token:"class",foreground:"73d0ff"},{token:"interface",foreground:"73d0ff"},{token:"support.class",foreground:"73d0ff"},{token:"support.type",foreground:"73d0ff"},{token:"tag",foreground:"5ccfe6"},{token:"tag.js",foreground:"5ccfe6"},{token:"metatag",foreground:"5ccfe6"},{token:"attribute.name",foreground:"ffd580"},{token:"attribute.value",foreground:"bae67e"},{token:"regexp",foreground:"95e6cb"},{token:"string.regexp",foreground:"95e6cb"},{token:"meta.brace",foreground:"cbccc6b3"},{token:"punctuation",foreground:"cbccc6b3"}],colors:{"editor.background":"#1f2430","editor.foreground":"#cbccc6","editor.lineHighlightBackground":"#191e2a","editor.lineHighlightBorder":"#191e2a","editor.selectionBackground":"#34455a","editor.inactiveSelectionBackground":"#2d3b4d","editorLineNumber.foreground":"#707a8c","editorLineNumber.activeForeground":"#cbccc6","editorCursor.foreground":"#ffcc66","editorWhitespace.foreground":"#3e4b59","editorIndentGuide.background":"#3e4b59","editorIndentGuide.activeBackground":"#5c6773","editorGutter.background":"#1a1f29","editorWidget.background":"#1f2430","editorWidget.border":"#101521","editorSuggestWidget.background":"#1f2430","editorSuggestWidget.border":"#101521","editorSuggestWidget.selectedBackground":"#34455a","editorHoverWidget.background":"#1f2430","editorHoverWidget.border":"#101521","input.background":"#1a1f29","input.border":"#101521",focusBorder:"#ffcc6633","list.activeSelectionBackground":"#34455a","list.hoverBackground":"#2d3b4d","scrollbarSlider.background":"#707a8c33","scrollbarSlider.hoverBackground":"#707a8c55","scrollbarSlider.activeBackground":"#707a8c77"}};function co({onRun:e,isExecuting:t,isLiveMode:n,children:r}){return w.jsxs("div",{className:"code-toolbar",children:[w.jsx("button",{className:"toolbar-button toolbar-button-primary",onClick:e,disabled:t&&!n,title:"Run code",children:t&&!n?"...":"▶"}),w.jsx("div",{className:"toolbar-buttons",children:r})]})}const uo=500;function fo({code:e,onCodeChange:t,isLiveMode:n,onToggleLiveMode:r,onRun:o,onClear:a,isExecuting:i,generatedShapeCount:s,error:l,onDismissError:d,isDarkTheme:v,onThemeToggle:f}){const c=u.useMemo(()=>{for(const[m,C]of Object.entries(ro))if(e===C)return m;return null},[e]),h=u.useRef(null),b=u.useRef(null),k=u.useRef(null),z=u.useRef(o);z.current=o;const x=u.useRef(n);x.current=n;const T=u.useRef(i);T.current=i;const B=u.useRef(null),O=u.useRef(null);u.useEffect(()=>{if(n)return B.current&&clearTimeout(B.current),B.current=setTimeout(()=>{if(!x.current||!h.current||!b.current||T.current)return;const m=h.current.getModel();if(!m)return;const C=h.current.getValue();if(C===O.current)return;b.current.editor.getModelMarkers({resource:m.uri}).some($=>$.severity===b.current.MarkerSeverity.Error)?O.current=null:(O.current=C,z.current(C))},uo),()=>{B.current&&clearTimeout(B.current)}},[e,n]),u.useEffect(()=>{if(!h.current||!b.current)return;const m=b.current,C=h.current,P=C.getModel();P&&(k.current&&k.current.clear(),m.editor.setModelMarkers(P,"code-executor",[]),l?.line&&(m.editor.setModelMarkers(P,"code-executor",[{startLineNumber:l.line,startColumn:l.column||1,endLineNumber:l.line,endColumn:P.getLineMaxColumn(l.line),message:l.message,severity:m.MarkerSeverity.Error}]),k.current=C.createDecorationsCollection([{range:new m.Range(l.line,1,l.line,1),options:{isWholeLine:!0,className:"error-line-highlight",glyphMarginClassName:"error-glyph-margin"}}]),C.revealLineInCenter(l.line)))},[l]);const j=u.useCallback(m=>{m.editor.defineTheme("dark",lo),m.editor.defineTheme("light",so)},[]),y=u.useCallback(()=>{f(),b.current&&b.current.editor.setTheme(v?"light":"dark")},[v,f]),g=u.useCallback((m,C)=>{h.current=m,b.current=C,C.languages.typescript.typescriptDefaults.setDiagnosticsOptions({noSemanticValidation:!1,noSyntaxValidation:!1}),C.languages.typescript.typescriptDefaults.setCompilerOptions({target:C.languages.typescript.ScriptTarget.ESNext,allowNonTsExtensions:!0,noEmit:!0,strict:!1,noImplicitAny:!1,strictNullChecks:!1}),C.languages.typescript.typescriptDefaults.addExtraLib(Vr,"ts:editor-api.d.ts"),m.onKeyDown(P=>{(P.metaKey||P.ctrlKey)&&P.keyCode===C.KeyCode.Enter&&(P.preventDefault(),P.stopPropagation(),z.current(m.getValue()))}),m.focus()},[]),X=u.useCallback(m=>{t(m||""),d()},[t,d]),N=u.useCallback((m,C)=>{t(C),h.current&&(h.current.setValue(C),h.current.focus()),o(C)},[t,o]);return w.jsxs("div",{className:`code-panel ${v?"theme-dark":"theme-light"}`,onKeyDown:m=>m.stopPropagation(),onKeyUp:m=>m.stopPropagation(),children:[w.jsxs(co,{onRun:()=>o(e),isExecuting:i,isLiveMode:n,children:[w.jsx("button",{className:`toolbar-button live-toggle ${n?"active":""}`,onClick:r,"aria-label":n?"Disable live mode":"Enable live mode",title:n?"Live mode on (auto-runs on valid changes)":"Live mode off",children:w.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:w.jsx("path",{d:"M13 2L3 14h9l-1 8 10-12h-9l1-8z"})})}),w.jsx("button",{className:"toolbar-button clear-button",onClick:a,disabled:s===0,title:`Clear generated shapes (${s} shapes)`,children:w.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:w.jsx("path",{d:"M3 6h18M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2"})})}),w.jsx("button",{className:"toolbar-button theme-toggle",onClick:y,"aria-label":v?"Switch to light theme":"Switch to dark theme",children:v?w.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[w.jsx("circle",{cx:"12",cy:"12",r:"5"}),w.jsx("path",{d:"M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"})]}):w.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:w.jsx("path",{d:"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"})})})]}),w.jsxs("div",{className:"code-panel-main",children:[w.jsx(io,{onLoadExample:N,selectedExample:c}),w.jsx("div",{className:"code-editor-wrapper",children:w.jsx(Wr,{height:"100%",defaultLanguage:"typescript",value:e,onChange:X,beforeMount:j,onMount:g,theme:v?"dark":"light",options:{fontSize:14,fontFamily:"'JetBrains Mono', 'Fira Code', monospace",lineHeight:1.5,minimap:{enabled:!1},scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:2,wordWrap:"on",padding:{top:4},glyphMargin:!1,folding:!1,lineNumbers:"on",lineNumbersMinChars:1,lineDecorationsWidth:12,renderLineHighlight:"line",suggestOnTriggerCharacters:!0,quickSuggestions:!0,parameterHints:{enabled:!0},formatOnPaste:!0,formatOnType:!0,fixedOverflowWidgets:!0}})})]}),l&&w.jsxs("div",{className:"error-panel",children:[w.jsxs("div",{className:"error-panel-header",children:[w.jsx("span",{className:"error-panel-title",children:"Error"}),w.jsx("button",{className:"error-dismiss",onClick:d,"aria-label":"Dismiss error",children:"×"})]}),w.jsxs("div",{className:"error-panel-content",children:[w.jsxs("div",{className:"error-message",children:[l.line&&w.jsxs("span",{className:"error-location",children:["Line ",l.line,": "]}),l.message]}),l.stack&&w.jsxs("details",{className:"error-stack-details",children:[w.jsx("summary",{children:"Stack trace"}),w.jsx("pre",{className:"error-stack",children:l.stack})]})]})]})]})}const kt="code-editor-theme",zt="code-editor-code",Lt="code-editor-live-mode";function Je(e){try{return localStorage.getItem(e)}catch{return null}}function Qe(e,t){try{localStorage.setItem(e,t)}catch{}}function po(){const e=u.useRef(null),[t,n]=u.useState(!1),[r,o]=u.useState(!1),[a,i]=u.useState(null),[s,l]=u.useState(0),[d,v]=u.useState(()=>Je(zt)??oo),[f,c]=u.useState(()=>Je(Lt)==="true"),[h,b]=u.useState(()=>Je(kt)!=="light"),k=u.useRef(null),z=u.useRef(0);u.useEffect(()=>{Qe(zt,d)},[d]),u.useEffect(()=>{Qe(Lt,String(f))},[f]),u.useEffect(()=>{Qe(kt,h?"dark":"light")},[h]),u.useEffect(()=>{const O=j=>{if(j.source!==e.current?.contentWindow)return;const y=j.data;if(!(!y||typeof y!="object"))switch(y.type){case"ready":n(!0);break;case"result":{const g=k.current;g&&g.id===y.id&&(!y.success&&y.error&&i(y.error),g.resolve(),k.current=null,o(!1));break}case"runtime-error":i(y.error);break;case"shape-count":l(y.count);break}};return window.addEventListener("message",O),()=>window.removeEventListener("message",O)},[]),u.useEffect(()=>{t&&e.current?.contentWindow?.postMessage({type:"color-scheme",scheme:h?"dark":"light"},"*")},[t,h]);const x=u.useCallback(async O=>{if(!t||r)return;o(!0),i(null);const j=String(++z.current);return new Promise(y=>{k.current={id:j,resolve:y},e.current?.contentWindow?.postMessage({type:"run",id:j,code:O},"*")})},[t,r]),T=u.useRef(!1);u.useEffect(()=>{!t||T.current||!d||(T.current=!0,x(d))},[t,d,x]);const B=u.useCallback(()=>{i(null),!(s>10&&!confirm(`Clear ${s} generated shapes?`))&&e.current?.contentWindow?.postMessage({type:"clear"},"*")},[s]);return w.jsx("div",{className:`editor-container ${h?"theme-dark":"theme-light"}`,children:w.jsxs(Ft,{direction:"horizontal",children:[w.jsx(et,{defaultSize:40,minSize:30,maxSize:80,children:w.jsx(fo,{code:d,onCodeChange:v,isLiveMode:f,onToggleLiveMode:()=>c(O=>!O),onRun:x,onClear:B,isExecuting:r,generatedShapeCount:s,error:a,onDismissError:()=>i(null),isDarkTheme:h,onThemeToggle:()=>b(O=>!O)})}),w.jsx(Ut,{className:"resize-handle"}),w.jsx(et,{minSize:20,children:w.jsx("iframe",{ref:e,src:"sandbox.html",sandbox:"allow-scripts",allow:"clipboard-read; clipboard-write",title:"Canvas sandbox",style:{width:"100%",height:"100%",border:"none",display:"block",background:"#1a1a1a"}})})]})})}const rn=document.getElementById("root");if(!rn)throw new Error("Root element not found");an.createRoot(rn).render(w.jsx(u.StrictMode,{children:w.jsx(po,{})}));
